...
m1 <- svyglm(art_exposure ~ age_cat + highestpassed2 + community + wellbeing_score, 
             design = svydf6,
             family = "binomial")

m2 <- svyglm(art_exposure ~ age_cat + highestpassed2 + community + resilience_score, 
             design = svydf6,
             family = "binomial")
...
m9 <- svyglm(art_exposure ~ age_cat + highestpassed2 + community + gender_equity_score, 
             design = svydf6,
             family = "binomial")
