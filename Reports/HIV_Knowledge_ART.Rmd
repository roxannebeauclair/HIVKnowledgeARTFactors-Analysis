...
tab1 <- recap_bi_numvar_svy(svy = svydf1, var = age, byvar = hiv_knowledge)
...
tab7 <- recap_bi_catvar_svy(svy = svydf1, var = auditCcat, byvar = hiv_knowledge)
tab8 <- recap_bi_catvar_svy(svy = svydf1, var = duditcat, byvar = hiv_knowledge)
tab9 <- recap_bi_catvar_svy(svy = svydf2, var = pregever, byvar = hiv_knowledge)
tab10 <- recap_bi_catvar_svy(svy = svydf1, var = ipv_any, byvar = hiv_knowledge)
tab11 <- recap_bi_catvar_svy(svy = svydf1, var = ever_raped, byvar = hiv_knowledge)
tab12 <- recap_bi_numvar_svy(svy = svydf1, var = wellbeing_score, byvar = hiv_knowledge)
tab13 <- recap_bi_numvar_svy(svy = svydf1, var = resilience_score, byvar = hiv_knowledge)
tab14 <- recap_bi_numvar_svy(svy = svydf1, var = support_family_score, byvar = hiv_knowledge)
tab15 <- recap_bi_numvar_svy(svy = svydf1, var = support_peers_score, byvar = hiv_knowledge)
tab16 <- recap_bi_numvar_svy(svy = svydf1, var = support_specialperson_score, byvar = hiv_knowledge)
tab17 <- recap_bi_numvar_svy(svy = svydf1, var = group_membership_score, byvar = hiv_knowledge)
tab18 <- recap_bi_numvar_svy(svy = svydf1, var = support_group_score, byvar = hiv_knowledge)
tab19 <- recap_bi_numvar_svy(svy = svydf1, var = support_individuals_score, byvar = hiv_knowledge)
tab20 <- recap_bi_numvar_svy(svy = svydf1, var = gender_equity_score, byvar = hiv_knowledge)
tab21 <- recap_bi_catvar_svy(svy = svydf1, var = rel_status2, byvar = hiv_knowledge)
tab22 <- recap_bi_catvar_svy(svy = svydf1, var = bf, byvar = hiv_knowledge)
tab23 <- recap_bi_catvar_svy(svy = svydf1, var = ever_sex, byvar = hiv_knowledge)
tab24 <- recap_bi_catvar_svy(svy = svydf1, var = trans_sex, byvar = hiv_knowledge)
tab25 <- recap_bi_catvar_svy(svy = svydf2, var = partner_older_5, byvar = hiv_knowledge)
tab26 <- recap_bi_catvar_svy(svy = svydf1, var = condom, byvar = hiv_knowledge)
tab27 <- recap_bi_catvar_svy(svy = svydf1, var = contraception, byvar = hiv_knowledge)
tab28 <- recap_bi_catvar_svy(svy = svydf1, var = hiv_test, byvar = hiv_knowledge)
tab29 <- recap_bi_catvar_svy(svy = svydf4, var = freq_hiv_test, byvar = hiv_knowledge)
tab30 <- recap_bi_catvar_svy(svy = svydf4, var = result, byvar = hiv_knowledge)
...
htmlTable(hiv_knowledge_tab,
          ...
          rgroup = c("<b>Age<b>",  
                     ...
                     "<b>Had an high alcohol use (Audit-C score 2 or higher)<b>",
                     "<b>Had high drug use (Dudit score 2 or higher)<b>",
          ...
          n.tspanner = c(nrow(tab1) + nrow(tab2) + nrow(tab3) + nrow(tab4),
                         nrow(tab5) + nrow(tab6) + nrow(tab7) + nrow(tab8) + nrow(tab9) + nrow(tab10) + nrow(tab11),
                         nrow(tab12) + nrow(tab13) + nrow(tab14) + nrow(tab15) + nrow(tab16) + nrow(tab17) + nrow(tab18) + nrow(tab19) + nrow(tab20),
                         nrow(tab21) + nrow(tab22) + nrow(tab23) + nrow(tab24) + nrow(tab25) + nrow(tab26) + nrow(tab27),
                         nrow(tab28) + nrow(tab29) + nrow(tab30)),
...
tab1 <- recap_bi_numvar_svy(svy = svydf6, var = age, byvar = art_exposure)
...
tab7 <- recap_bi_catvar_svy(svy = svydf6, var = auditCcat, byvar = art_exposure)
tab8 <- recap_bi_catvar_svy(svy = svydf6, var = duditcat, byvar = art_exposure)
tab9 <- recap_bi_catvar_svy(svy = svydf7, var = pregever, byvar = art_exposure)
tab10 <- recap_bi_catvar_svy(svy = svydf6, var = ipv_any, byvar = art_exposure)
tab11 <- recap_bi_catvar_svy(svy = svydf6, var = ever_raped, byvar = art_exposure)
tab12 <- recap_bi_numvar_svy(svy = svydf6, var = wellbeing_score, byvar = art_exposure)
tab13 <- recap_bi_numvar_svy(svy = svydf6, var = resilience_score, byvar = art_exposure)
tab14 <- recap_bi_numvar_svy(svy = svydf6, var = support_family_score, byvar = art_exposure)
tab15 <- recap_bi_numvar_svy(svy = svydf6, var = support_peers_score, byvar = art_exposure)
tab16 <- recap_bi_numvar_svy(svy = svydf6, var = support_specialperson_score, byvar = art_exposure)
tab17 <- recap_bi_numvar_svy(svy = svydf6, var = group_membership_score, byvar = art_exposure)
tab18 <- recap_bi_numvar_svy(svy = svydf6, var = support_group_score, byvar = art_exposure)
tab19 <- recap_bi_numvar_svy(svy = svydf6, var = support_individuals_score, byvar = art_exposure)
tab20 <- recap_bi_numvar_svy(svy = svydf6, var = gender_equity_score, byvar = art_exposure)
tab21 <- recap_bi_numvar_svy(svy = svydf6, var = stigma_hivpos, byvar = art_exposure)
tab22 <- recap_bi_catvar_svy(svy = svydf6, var = rel_status2, byvar = art_exposure)
tab23 <- recap_bi_catvar_svy(svy = svydf6, var = bf, byvar = art_exposure)
tab24 <- recap_bi_catvar_svy(svy = svydf6, var = ever_sex, byvar = art_exposure)
tab25 <- recap_bi_catvar_svy(svy = svydf6, var = trans_sex, byvar = art_exposure)
tab26 <- recap_bi_catvar_svy(svy = svydf7, var = partner_older_5, byvar = art_exposure)
tab27 <- recap_bi_catvar_svy(svy = svydf6, var = condom, byvar = art_exposure)
tab28 <- recap_bi_catvar_svy(svy = svydf6, var = contraception, byvar = art_exposure)
tab29 <- recap_bi_catvar_svy(svy = svydf6, var = hiv_recent, byvar = art_exposure)
tab30 <- recap_bi_catvar_svy(svy = svydf9, var = miss_app, byvar = art_exposure)
...
htmlTable(art_tab,
          ...
          n.tspanner = c(nrow(tab1) + nrow(tab2) + nrow(tab3) + nrow(tab4),
                         nrow(tab5) + nrow(tab6) + nrow(tab7) + nrow(tab8) + nrow(tab9) + nrow(tab10) + nrow(tab11),
                         nrow(tab12) + nrow(tab13) + nrow(tab14) + nrow(tab15) + nrow(tab16) + nrow(tab17) + nrow(tab18) + nrow(tab19) + nrow(tab20) + nrow(tab21),
                         nrow(tab22) + nrow(tab23) + nrow(tab24) + nrow(tab25) + nrow(tab26) + nrow(tab27) + nrow(tab28),
                         nrow(tab29) + nrow(tab30)),
          css.tspanner = "background: lightgrey;",
          rowlabel = "Variable",
          css.rgroup = "",
...
m1 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + wellbeing_score, 
             design = svydf1,
             family = "binomial")

m2 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + resilience_score, 
             design = svydf1,
             family = "binomial")

m3 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + support_family_score, 
             design = svydf1,
             family = "binomial")

m4 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + support_peers_score, 
             design = svydf1,
             family = "binomial")

m5 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + support_specialperson_score, 
             design = svydf1,
             family = "binomial")

m6 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + group_membership_score, 
             design = svydf1,
             family = "binomial")

m7 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + support_group_score, 
             design = svydf1,
             family = "binomial")

m8 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + support_individuals_score, 
             design = svydf1,
             family = "binomial")

m9 <- svyglm(hiv_knowledge ~ age + highestpassed2 + community + gender_equity_score, 
             design = svydf1,
             family = "binomial")
...
m1 <- svyglm(art_exposure ~ age + highestpassed2 + community + wellbeing_score, 
             design = svydf6,
             family = "binomial")

m2 <- svyglm(art_exposure ~ age + highestpassed2 + community + resilience_score, 
             design = svydf6,
             family = "binomial")

m3 <- svyglm(art_exposure ~ age + highestpassed2 + community + support_family_score, 
             design = svydf6,
             family = "binomial")

m4 <- svyglm(art_exposure ~ age + highestpassed2 + community + support_peers_score, 
             design = svydf6,
             family = "binomial")

m5 <- svyglm(art_exposure ~ age + highestpassed2 + community + support_specialperson_score, 
             design = svydf6,
             family = "binomial")

m6 <- svyglm(art_exposure ~ age + highestpassed2 + community + group_membership_score, 
             design = svydf6,
             family = "binomial")

m7 <- svyglm(art_exposure ~ age + highestpassed2 + community + support_group_score, 
             design = svydf6,
             family = "binomial")

m8 <- svyglm(art_exposure ~ age + highestpassed2 + community + support_individuals_score, 
             design = svydf6,
             family = "binomial")

m9 <- svyglm(art_exposure ~ age + highestpassed2 + community + gender_equity_score, 
             design = svydf6,
             family = "binomial")

m10 <- svyglm(art_exposure ~ age + highestpassed2 + community + stigma_hivpos, 
             design = svydf6,
             family = "binomial")
...
Only model two has a significant association between one of the constructs and being on ART. For each unit increase in resilience, there was a `r round(( tidy(m2, exponentiate = TRUE)$estimate[7]) - 1.00, 2) * 100`% increase in the odds of being on ART, after adjusting for confounders. 